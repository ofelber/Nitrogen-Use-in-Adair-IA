...
<html>
  ...
  <meta charset="utf-8">
      ...
      <title>Nitrogen Fertilizer Use in Adair County, IA</title>
  ...
  <body>
    ...
    <?php
      ...
      $query = "SELECT amount FROM location_amount WHERE nutrient_type_id = 1 AND fips_co = 1 AND location_type_id = 2 ORDER BY year";
    ...
    ctx.fillText('Non-farm Nitrogen Fertilizer Use in Adair County (tons)', offx+200, offy-20);
    ...
    <p><b>Figure 2.</b> Nitrogen-based fertilizer use in Adair, Iowa for non-farm applications from 1987 to 2006. Data courtesy of US DOI and USGS.</p>
    <!--<button type="button">Farm Use</button>-->
    <a href="farmNitrogenAdair.php"><button type="button">Farm Use</button></a>
  </body>
</html>
