...
<p><b>Figure 1.</b> Nitrogen-based fertilizer use in Adair, Iowa for farm applications from 1987 to 2006. Data courtesy of US DOI and USGS.</p>
    <!--<button type="button">Farm Use</button>-->
    <a href="nonfarmNitrogenAdair.php"><button type="button">Non-farm Use</button></a>
  </body>
</html>